...
  if (success) {
    return (
      <main className="grid min-h-screen place-items-center bg-nestly-soft px-5">
...
          <p className="mt-4 rounded-2xl bg-nestly-soft p-4 font-black">
            {form.email}
          </p>

          <p className="mt-4 text-sm text-nestly-muted">
            Press the confirmation link in the email, then log in.
          </p>
...
          Join Nestly as a customer or provider.
        </p>
